...
use Fisharebest\Localization\Locale\LocaleTkCyrlTm;
...
/**
 * Tests for the LocaleTkCyrlTm class
 *
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleTkCyrlTm
 */
class LocaleTkCyrlTmTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('түркменче', $locale->endonymSortable());
