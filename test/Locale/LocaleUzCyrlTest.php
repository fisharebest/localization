...
use Fisharebest\Localization\Locale\LocaleUzCyrl;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleUzCyrl
 */
class LocaleUzCyrlTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('uz_UZ@cyrillic', $locale->code());
        ...
        self::assertSame('uz-Cyrl', $locale->languageTag());
