...
use Fisharebest\Localization\Locale\LocaleIw;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleHe
 */
class LocaleIwTest extends TestCase
{
    /**
     * Test the properties
     */
    ...
    {
        $locale = new LocaleIw(); // iw is deprecated - use he
        ...
        self::assertSame('עברית', $locale->endonymSortable());
