...
use Fisharebest\Localization\Locale\LocaleMznIr;
...
/**
 * Tests for the LocaleMznIr class
 *
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleMznIr
 */
class LocaleMznIrTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('مازرونی', $locale->endonymSortable());
