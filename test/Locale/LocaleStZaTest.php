...
/**
 * Unit tests for the LocaleStLs class
 *
...
class LocaleStZaTest extends TestCase {
	...
	public function testProperties() {
		...
		$this->assertSame('st_ZA', $locale->code());
		$this->assertSame('unicode_ci', $locale->collation());
		$this->assertSame('0123456789', $locale->digits('0123456789'));
		$this->assertSame('Sesotho', $locale->endonym());
		$this->assertSame('lang="st-ZA"', $locale->htmlAttributes());
		$this->assertSame('st-ZA', $locale->languageTag());
