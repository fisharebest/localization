...
use Fisharebest\Localization\Locale\LocaleUrIn;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleUrIn
 */
class LocaleUrInTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('ur_IN', $locale->code());
        ...
        self::assertSame('ur-IN', $locale->languageTag());
