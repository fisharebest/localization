...
use Fisharebest\Localization\Locale\LocaleEs419;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleEs419
 */
class LocaleEs419Test extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('ESPANOL LATINOAMERICANO', $locale->endonymSortable());
