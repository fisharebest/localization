...
use Fisharebest\Localization\Locale\LocaleTsZa;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleTsZa
 */
class LocaleTsZaTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('ts_ZA', $locale->code());
        self::assertSame('unicode_ci', $locale->collation());
        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('ltr', $locale->direction());
        self::assertSame('Xitsonga', $locale->endonym());
        self::assertSame('XITSONGA', $locale->endonymSortable());
        self::assertSame('lang="ts"', $locale->htmlAttributes());
        self::assertSame('ts', $locale->languageTag());
