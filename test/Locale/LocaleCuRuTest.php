...
use Fisharebest\Localization\Locale\LocaleCuRu;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleCuRu
 */
class LocaleCuRuTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('ЦЕРКОВНОСЛОВЕ́НСКЇЙ', $locale->endonymSortable());
