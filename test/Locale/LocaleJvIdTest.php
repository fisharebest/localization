...
use Fisharebest\Localization\Locale\LocaleJvId;
...
/**
 * Tests for the LocaleJvId class
 *
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleJvId
 */
class LocaleJvIdTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('ꦧꦱꦗꦮ', $locale->endonymSortable());
