...
use Fisharebest\Localization\Locale\LocaleBrx;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleBrx
 */
class LocaleBrxTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('बर’', $locale->endonym());
        self::assertSame('बर’', $locale->endonymSortable());
