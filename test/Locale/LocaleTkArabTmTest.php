...
use Fisharebest\Localization\Locale\LocaleTkArabTm;
...
/**
 * Tests for the LocaleTkArabTm class
 *
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleTkArabTm
 */
class LocaleTkArabTmTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('تورکمنچه', $locale->endonymSortable());
