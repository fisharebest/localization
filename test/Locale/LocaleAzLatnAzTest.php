...
use Fisharebest\Localization\Locale\LocaleAzLatnAz;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleAzLatnAz
 */
class LocaleAzLatnAzTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('AZERBAYCAN', $locale->endonymSortable());
