...
use Fisharebest\Localization\Locale\LocaleTiEt;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleTiEt
 */
class LocaleTiEtTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('ti_ET', $locale->code());
        ...
        self::assertSame('ti', $locale->languageTag());
