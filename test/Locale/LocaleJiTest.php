...
use Fisharebest\Localization\Locale\LocaleJi;
 ...
 */
class LocaleJiTest extends TestCase
{
    /**
     * Test the properties
     */
    ...
    {
        $locale = new LocaleJi(); // ji is deprecated - use yi
