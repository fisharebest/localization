...
/**
 * Unit tests for the LocaleEsGt class
 *
...
class LocaleEsGtTest extends TestCase {
	...
	public function testProperties() {
		...
		$this->assertEquals(new TerritoryGt, $locale->territory());
		$this->assertNull($locale->variant());
		$this->assertSame('es_GT', $locale->code());
		$this->assertSame('spanish_ci', $locale->collation());
		$this->assertSame('0123456789', $locale->digits('0123456789'));
		$this->assertSame('lang="es-GT"', $locale->htmlAttributes());
		$this->assertSame('es-GT', $locale->languageTag());
