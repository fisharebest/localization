...
use Fisharebest\Localization\Locale\LocaleTnZa;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleTnZa
 */
class LocaleTnZaTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('tn_ZA', $locale->code());
        ...
        self::assertSame('tn-ZA', $locale->languageTag());
