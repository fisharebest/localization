...
/**
 * Unit tests for the LocaleEnDk class
 *
...
class LocaleEnDkTest extends TestCase {
	...
	public function testProperties() {
		...
		$this->assertSame('en_DK', $locale->code());
		$this->assertSame('unicode_ci', $locale->collation());
		$this->assertSame('0123456789', $locale->digits('0123456789'));
		$this->assertSame('English', $locale->endonym());
		$this->assertSame('lang="en-DK"', $locale->htmlAttributes());
		$this->assertSame('en-DK', $locale->languageTag());
