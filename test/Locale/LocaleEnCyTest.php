...
use Fisharebest\Localization\Locale\LocaleEnCy;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleEnCy
 */
class LocaleEnCyTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('en_CY', $locale->code());
        ...
        self::assertSame('en-CY', $locale->languageTag());
