...
use Fisharebest\Localization\Locale\LocaleCkb;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleCkb
 */
class LocaleCkbTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('ckb', $locale->languageTag());
