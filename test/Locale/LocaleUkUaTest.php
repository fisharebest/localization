...
use Fisharebest\Localization\Locale\LocaleUkUa;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleUkUa
 */
class LocaleUkUaTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('uk_UA', $locale->code());
        self::assertSame('unicode_ci', $locale->collation());
        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('ltr', $locale->direction());
        self::assertSame('українська', $locale->endonym());
        self::assertSame('УКРАЇНСЬКА', $locale->endonymSortable());
        self::assertSame('lang="uk"', $locale->htmlAttributes());
        self::assertSame('uk', $locale->languageTag());
