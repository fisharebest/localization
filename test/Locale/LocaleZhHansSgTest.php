...
use Fisharebest\Localization\Locale\LocaleZhHansSg;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleZhHansSg
...
class LocaleZhHansSgTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        ...
        self::assertSame('zh_SG', $locale->code());
        ...
        self::assertSame('zh-SG', $locale->languageTag());
