...
/**
 * Unit tests for the LocaleNlSx class
 *
...
class LocaleNlSxTest extends TestCase {
	...
	public function testProperties() {
		...
		$this->assertSame('nl_SX', $locale->code());
		$this->assertSame('0123456789', $locale->digits('0123456789'));
		$this->assertSame('lang="nl-SX"', $locale->htmlAttributes());
		$this->assertSame('nl-SX', $locale->languageTag());
