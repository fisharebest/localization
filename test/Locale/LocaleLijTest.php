...
use Fisharebest\Localization\Locale\LocaleLij;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleLij
 */
class LocaleLijTest extends TestCase
{
    ...
    public function testProperties()
    {
        ...
        self::assertSame('Líguru', $locale->endonym());
        self::assertSame('LÍGURU', $locale->endonymSortable());
