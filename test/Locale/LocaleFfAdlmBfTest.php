...
use Fisharebest\Localization\Locale\LocaleFfAdlmBf;
 ...
 * @covers \Fisharebest\Localization\Locale\LocaleFfAdlmBf
 */
class LocaleFfAdlmBfTest extends TestCase
{
    /**
     * Test the properties
     */
    public function testProperties()
    {
        ...
        self::assertSame('ff_BF@adlam', $locale->code());
        ...
        self::assertSame('lang="ff-Adlm-BF" dir="rtl"', $locale->htmlAttributes());
        self::assertSame('ff-Adlm-BF', $locale->languageTag());
