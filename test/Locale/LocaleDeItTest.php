...
/**
 * Unit tests for the LocaleDeIt class
 *
...
class LocaleDeItTest extends TestCase {
	...
	public function testProperties() {
		...
		$this->assertSame('de_IT', $locale->code());
		$this->assertSame('german2_ci', $locale->collation());
		$this->assertSame('0123456789', $locale->digits('0123456789'));
		$this->assertSame('lang="de-IT"', $locale->htmlAttributes());
		$this->assertSame('de-IT', $locale->languageTag());
